...
<div class="max-w-md mx-auto px-4 mt-6">
  ...
  <figure class="px-10 pt-10">
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTpPrwKtq0oriHg61ibbz5QznYC8hXZsUuwRu91pe5jXs21Gb_3U81iqeWgBa83yyJUZZE&usqp=CAU" alt="Shoes" class="rounded-xl" style="width:500px" />
  </figure>
      </div>
      <div class=" px-4">
        <h2 class="mb-2 leading-tight tracking-tight font-bold text-gray-800 text-2xl md:text-3xl">The Title.</h2>
        <p class="text-gray-500 text-sm">By <a href="#" class="text-green-500 hover:underline">Greenly</a></p>
